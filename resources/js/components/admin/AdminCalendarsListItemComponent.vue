                ...
                <div class="row align-items-center">
                    <div class="col-lg-6" >
                        <div>
                            ...
                            <a v-else :href="calendar.publicUrl" target="_blank">View all</a>
                        </div>
                    </div>
                ...
                <div class="card calendar-events">
                    ...
                    <div class="events-list">
                        <div v-for="(event, index) in sortedEvents"  v-bind:class="{ 'hidden-event': index < view_events_start || index > view_events_end }">
                            <admin-calendars-list-item-event-component :event="event" :calendar="calendar" ref="event"></admin-calendars-list-item-event-component>
                        </div>
                    </div>
